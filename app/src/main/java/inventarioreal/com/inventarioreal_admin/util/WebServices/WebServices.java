...
public class WebServices {
    ...
    public static void rotationProyected(final int days, final String product_id, final Activity activity, final Administrador admin, final ResultWebServiceInterface result){
        final String url=Constants.url+Constants.ws_rotationProyected;
        RotationProyectedReportRequest request = new RotationProyectedReportRequest(days, product_id);
        post(url, request.getCampos(), R.string.consultando, activity, admin, new ResponseListener() {
            @Override
            public void onResponse(String s) {
