...
public class CrearInventarioColaborativoRequest {
    private Inventarios inventarios;
    private List<InventariosProductos> inventario_productos;

    public CrearInventarioColaborativoRequest(long zonas_id, List<InventariosProductos> inventario_productos) {
    ...
    private String getInventario(){
        ...
        object.addProperty(Constants.colaborativo, true);
