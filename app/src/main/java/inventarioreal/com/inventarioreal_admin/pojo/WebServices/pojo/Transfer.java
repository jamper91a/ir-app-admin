...
public class Transfer extends InventarioRealPojo {
    ...
    public ContentValues getContentValues() {
        ...
        values.put(Constants.column_employee, employee.getId());
        values.put(Constants.column_shopSource, shopSource.getId());
        values.put(Constants.column_shopshopDestination, shopDestination.getId());
