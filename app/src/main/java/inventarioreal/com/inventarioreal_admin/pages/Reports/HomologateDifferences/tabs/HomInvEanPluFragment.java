...
public class HomInvEanPluFragment extends Fragment {

    private HomInvEanPluViewModel mViewModel;
    ...
    public static HomInvEanPluFragment newInstance() {
        return new HomInvEanPluFragment();
    }
    ...
    private void getData(){
        mViewModel = ViewModelProviders.of(getActivity()).get(HomInvEanPluViewModel.class);
