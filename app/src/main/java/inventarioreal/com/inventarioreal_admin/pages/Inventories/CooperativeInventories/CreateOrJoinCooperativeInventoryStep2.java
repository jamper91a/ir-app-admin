...
import inventarioreal.com.inventarioreal_admin.pages.Inventories.CooperativeInventories.Create.CreateCooperativeInventoryStep1;
...
public class CreateOrJoinCooperativeInventoryStep2 extends CicloActivity {
...
//        rfdiReader.startReader();
    ...
    public void initGui() {
        ...
        if(!request.isUnion()) {
            getElemento(R.id.titleTxt).setText(getString(R.string.crear_inventario_cooperativo));
            titleIcn.setImageDrawable(getDrawable(R.drawable.icn_co_inventory_create_blue));
        }else {
            getElemento(R.id.titleTxt).setText(getString(R.string.unirse_inventario_cooperativo));
            titleIcn.setImageDrawable(getDrawable(R.drawable.icn_inventory_join_blue));
        }
...
//        }
    ...
    private CreateOrJoinCooperativeInventoryStep2.SectionsPagerAdapter mSectionsPagerAdapter;
    public void tabsInit() {
//        /region Tabs section
        // Create the adapter that will return a fragment for each of the three
        // primary sections of the activity.
        mSectionsPagerAdapter = new CreateOrJoinCooperativeInventoryStep2.SectionsPagerAdapter(getSupportFragmentManager());
    ...
    private void showDialog(){
        ...
        if(!request.isUnion())
            ...
            builder.setTitle(R.string.unirse_inventario_cooperativo);
        ...
        request.setDate(request.getDate().replace("T", " "));
        txtFecha.setText(request.getDate().split(" ")[0]);
        txtTime.setText(request.getDate().split(" ")[1]);
        builder.setView(dialogView);

        final AlertDialog show = builder.show();
        if(!request.isUnion()) {
            titleTxt.setText(R.string.crear_inventario_cooperativo);
            titleIcn.setImageDrawable(getDrawable(R.drawable.icn_co_inventory_create_blue));
        }else {
            titleTxt.setText(R.string.unirse_inventario_cooperativo);
            titleIcn.setImageDrawable(getDrawable(R.drawable.icn_inventory_join_blue));
        }
            ...
            public void onClick(View view) {
                ...
                if(request.getInventory() ==null){
                    WebServices.createCollaborativeInventory(
                            ...
                            products,
                            CreateOrJoinCooperativeInventoryStep2.this,
                            admin,
                            new ResultWebServiceInterface() {
                                @Override
                                public void ok(ResultWebServiceOk ok) {
                                    admin.toast("Inventario creado con exito");
                                    Administrador.callIntent(CreateCooperativeInventoryStep1.class, null);
                                }
                    ...
                    WebServices.attachInventory(
                            ...
                            new ResultWebServiceInterface() {
                                ...
                                public void ok(ResultWebServiceOk ok) {
                                    ...
                                    Administrador.callIntent(UnirseInventariosCooperativo.class, null);
                                }
