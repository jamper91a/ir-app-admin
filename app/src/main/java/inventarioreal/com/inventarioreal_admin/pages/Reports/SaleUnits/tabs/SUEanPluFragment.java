...
public class SUEanPluFragment extends Fragment {

    private SUEanPluViewModel mViewModel;
    ...
    public static SUEanPluFragment newInstance() {
        return new SUEanPluFragment();
    }
    ...
    private void getData(){
        mViewModel = ViewModelProviders.of(getActivity()).get(SUEanPluViewModel.class);
