...
public class ConsolidateInventoryStep1 extends CicloActivity {
            ...
            public void onClick(View v) {
                try {
                    ...
                    WebServices.consolidateInventories(
                            ...
                            inventarioName,
                            ConsolidateInventoryStep1.this,
                            admin,
    ...
    private void getinventariosPorConsolidar() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ConsolidateInventoryStep1.this);
        recyclerView.setLayoutManager(linearLayoutManager);
        adapter = new RecyclerAdapterInventariosAConsolidar(ConsolidateInventoryStep1.this, inventariosPorConsolidar, admin);
