...
public class ViewInventory extends CicloActivity {
...
//    final DataBase db = DataBase.getInstance(this);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(this.inventario!=null) {
            ...
            getSupportActionBar().setTitle(R.string.visualizar_inventarios_consolidados);
        }
    ...
    public void initGui() {
        ...
        if(this.inventario!=null) {
            getElemento(R.id.titleTxt).setText(getString(R.string.visualizar_inventarios_parciales_por_zonas));
            titleIcn.setImageDrawable(getDrawable(R.drawable.icn_inventory_view_by_zone_blue));
        } else {
            getElemento(R.id.titleTxt).setText(getString(R.string.visualizar_inventarios_consolidados));
            titleIcn.setImageDrawable(getDrawable(R.drawable.icn_inventory_view_consolidate_blue));
        }
