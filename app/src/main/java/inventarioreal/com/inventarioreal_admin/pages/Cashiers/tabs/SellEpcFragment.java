...
public class SellEpcFragment extends Fragment {

    private SellEpcViewModel mViewModel;
    private LinkedHashMap<Integer, View> elementos;
    public ListAdapterTotalReportEpcDetails adapter1;
    private Administrador admin;


    public static SellEpcFragment newInstance() {
        return new SellEpcFragment();
    }
    ...
    private void getData(){
        mViewModel = ViewModelProviders.of(getActivity()).get(SellEpcViewModel.class);
