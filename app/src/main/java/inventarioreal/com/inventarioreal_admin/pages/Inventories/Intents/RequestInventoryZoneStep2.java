...
public class RequestInventoryZoneStep2 implements IntentRequests {
    ...
    public RequestInventoryZoneStep2() {
    }

    public RequestInventoryZoneStep2(Inventory inventory) {
        this.inventory = inventory;
    }

    public RequestInventoryZoneStep2(ConsolidatedInventory consolidatedInventory) {
