...
public class ManifiestoElectronicoSalidas extends CicloActivity {

    private static final String TAG = "ManifiestoElectronicoSalida";
...
//    private final DataBase db = DataBase.getInstance(this);
    ...
    @Override
    public void getData() {
        this.getTransferenciasSalida();
    }

    private void getTransferenciasSalida() {
...
//                        productosUnicos++;
                ...
                transferenciaDetails.setTransfer(transferencia);
                transferenciaDetails.setType(getString(R.string.manifiesto_electronico_salidas));
        ...
        WebServices.getTranfersByType(Constants.transferencias_salida,this, admin, new ResultWebServiceInterface() {
            @Override
