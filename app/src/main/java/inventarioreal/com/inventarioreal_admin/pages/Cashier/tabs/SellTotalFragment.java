...
public class SellTotalFragment extends Fragment {

    private SellTotalViewModel mViewModel;
    private LinkedHashMap<Integer, View> elementos;

    public static SellTotalFragment newInstance() {
        return new SellTotalFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(getActivity()).get(SellTotalViewModel.class);
