...
public class InventarioCrear1 extends Activity {
...
//                request.setZona_id(zonas.get(position).getId());
//            }
//
//            @Override
