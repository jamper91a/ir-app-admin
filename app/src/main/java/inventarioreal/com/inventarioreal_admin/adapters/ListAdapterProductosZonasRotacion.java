...
public class ListAdapterProductosZonasRotacion extends RecyclerView.Adapter<ListAdapterProductosZonasRotacion.ViewHolder> {
    ...
    public ListAdapterProductosZonasRotacion(Activity activity, Administrador admin, LinkedList<ProductHasZone> items, OnItemClickListener onItemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            case TYPE_HEADER:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.header_list_productos_zonas_rotacion, parent, false);
                break;
            case TYPE_ITEM:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_productos_zonas_rotacion, parent, false);
                break;
        }
...
//                holder.bind(item);
    ...
    class ViewHolder extends  RecyclerView.ViewHolder{
        ...
        //region Header items
        TextView txtTotal, txtEanPlu, txtDetails, txtVendidas, txtDiferencia;
        ...
        public ViewHolder(View view, int viewType) {
            ...
            if(viewType==TYPE_ITEM)
            {
                ...
                this.txtVendidas = (TextView)view.findViewById(R.id.txtVendidas);
                this.txtDiferencia = (TextView)view.findViewById(R.id.txtDiferencia);
        ...
        public TextView getTxtVendidas() {
            return txtVendidas;
        }

        public void setTxtVendidas(TextView txtVendidas) {
            this.txtVendidas = txtVendidas;
        }

        public TextView getTxtDiferencia() {
            return txtDiferencia;
        }

        public void setTxtDiferencia(TextView txtDiferencia) {
            this.txtDiferencia = txtDiferencia;
        }
