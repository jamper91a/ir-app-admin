...
public class ListAdapterProductosZonasReturnsVisual extends RecyclerView.Adapter<ListAdapterProductosZonasReturnsVisual.ViewHolder> {
    ...
    public ListAdapterProductosZonasReturnsVisual(Activity activity, Administrador admin, LinkedList<ProductHasZone> items, OnItemClickListener onItemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=null;
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_productos_zonas_returns_visual, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.getTxt3().setText(item.getProduct().getSupplier().getName());
//        holder.getTxt2().setText(item.getProduct().getDescription());
