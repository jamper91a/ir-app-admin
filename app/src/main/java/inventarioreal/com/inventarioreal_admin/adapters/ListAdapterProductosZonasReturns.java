...
public class ListAdapterProductosZonasReturns extends RecyclerView.Adapter<ListAdapterProductosZonasReturns.ViewHolder> {
    ...
    public ListAdapterProductosZonasReturns(Activity activity, Administrador admin, LinkedList<ProductHasZone> items, OnItemClickListener onItemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            case TYPE_HEADER:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.header_list_productos_zonas_returns, parent, false);
                break;
            case TYPE_ITEM:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_productos_zonas_returns, parent, false);
                break;
        }
...
//                holder.bind(item);
            ...
            case TYPE_ITEM:
                ...
                holder.getTxt4().setText(item.getProduct().getSupplier().getName());
                if(item.isError())
    ...
    class ViewHolder extends  RecyclerView.ViewHolder{
        ...
        //region Header items
        TextView txtTotal, txtEanPlu, txtDetails, txtProveedor;
        ...
        public TextView getTxtProveedor() {
            return txtProveedor;
        }

        public void setTxtProveedor(TextView txtProveedor) {
